    ...
    private static void remindPlayer(ProxiedPlayer player, long reminderPeriod) {
        try {
            ...
            player.sendMessage(
                    ...
                    .append("The last time you voted was over " + Util.formatTime(reminderPeriod, TimeUnit.SECONDS, false) + " ago, to vote again and earn more " + Perks.getConfigSetting("currency_reference_name", "money") + " for perks, type /vote or click this message to vote on the available services.\n\n")
